...
const CACHE_NAME = 'portal-colaborador-v6';
...
// ===== Notificações =====
// A notificação chega sem texto: o disparador só avisa que há novidade, e a mensagem é
// escrita aqui, no próprio celular. Assim nenhum conteúdo interno trafega por fora, e
// o envio dispensa a parte mais frágil do protocolo de push.
self.addEventListener('push', function(event){
  event.waitUntil(
    self.registration.showNotification('Portal do Colaborador', {
      body: 'Há novidade para você. Toque para abrir.',
      icon: './icon-192.png',
      badge: './icon-192.png',
      tag: 'portal-novidade',   // agrupa: dois avisos seguidos não viram duas linhas
      renotify: true,
      data: { url: './' }
    })
  );
